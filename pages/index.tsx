      ...
      <main>
        <Flex flexDir={"column"} bg={blue}>
          ...
          >
            ...
            <Flex flexDir={"column"} justifyContent={"start"} w="70%">
              <Text fontSize={"85px"} fontWeight="bold">
                КОДООС Ч ИЛҮҮГ...
              </Text>
              <Box h="20px" />
              <Text fontSize={text} textAlign={"start"} w="50%">
          ...
          <VStack ref={wrapperRef} color={"white"} w="50%" mx="auto">
            ...
            <Box h="50px" />
            <Text w="100%" fontSize={"24px"} textAlign={"justify"}>
          ...
          <VStack id="#what" w="100%" justifyContent={"center"}>
            <VStack>
              <Text fontSize={"85px"} color="white" fontWeight={"bold"}>
                Бид юу заах вэ?
              </Text>
            </VStack>
